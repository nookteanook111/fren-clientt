            ...
            <div className="sticky top-[100px] left-0 z-50 w-full">
              ...
              <div className="flex items-center">
                {isPurchased ? (
                  <>
                    {
                      ...
                      >
                        ...
                        :
                        <Link
                          className={`${styles.button} !w-[180px] my-3 cursor-pointer text-white !bg-secondary`}
                  ...
                  <div
                    className={`${styles.button} !w-[180px] my-3 text-white cursor-pointer !bg-secondary`}
                    onClick={handleOrder}
                  >
                    Buy Now {data.price}฿
                  </div>
