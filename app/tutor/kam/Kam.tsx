...
const experience = [
    {
        text: 'อาจารย์ประสบการณืติวข้อสอบความถนัดเเพทย์มากกว่า 3 ปี',
        secondText: ''
    },
    {
        text: 'คณะทันตเเพทย์ ม.นเรศวรเเละเภสัช ม.มหิดล',
        secondText: ''
    },
    {
        text: 'ผู้มีประสบการณ์ในการสอบเข้าคณะสายสุขภาพอย่างมาก',
        secondText: ''
    },
]
                ...
                <div data-aos="fade-up" className="w-full flex justify-center flex-col lg:flex-row items-center teacherExper">
                    ...
                    <div className="pt-0 md:pt-20">
                        <div className="md:w-[500px] bg-white shadow-lg relative px-5">
                            <div className=" text-[18px] md:text-[22px] font-bold mt-0 md:mt-0 md:absolute top-0 md:top-[-30px] px-10 py-2 bg- bg-yellow-400 text-white rounded-full drop-shadow-md">
                                <p className="text-center md:text-left"> ครูพี่แก้ม </p>
                            </div>
